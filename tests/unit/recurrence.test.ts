...
describe('expandOccurrences', () => {
  ...
  it('weekdays (v1.3): chỉ T2-T6, tôn trọng until', () => {
    // 2026-03-01 là Chủ nhật
    const e = ev({ id: 'a', date: '2026-03-01', repeat: 'weekdays', until: '2026-03-08' });
    const occ = expandOccurrences([e], '2026-03-01', '2026-03-15');
