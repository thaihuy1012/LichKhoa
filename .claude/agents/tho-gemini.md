...
3. Đợi: gọi `bash scripts/agy-run.sh cho <tên>` lặp lại cho tới khi thấy `XONG LƯỢT`. Mỗi lần gọi script tự trả về sau ≤100 giây. Trong lúc đợi không chạy lệnh nào khác, không đọc file code.
